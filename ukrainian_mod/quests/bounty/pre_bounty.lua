...
function setText()
  ...
  --quest.setTitle(sb.replaceTags("^orange;Винагорода: ^green;<bounty.name>", tags))
  quest.setTitle(RepTags("^orange;Винагорода: ^green;<bounty.name>", tags))
